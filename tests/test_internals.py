...
class AllTests:
    ...
    def test_rotation_invariance_value(
        self, q, rv, rank, merge_fun, join_fun, invar_mode
    ):
        r, v = rv
    ...
    def test_permutation_equivariance_value(
        ...
        prediction2 = self.value_prediction(
            rprime, vprime, key, rank, merge_fun, join_fun, invar_mode, reduce=False
        )
    ...
    @settings(deadline=None)
    @given(unit_quaternions(), point_cloud(), point_cloud())
